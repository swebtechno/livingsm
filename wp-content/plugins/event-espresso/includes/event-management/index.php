...
function event_espresso_manage_events() {
	...
	<div id="configure_organization_form" class="wrap meta-box-sortables ui-sortable">
		<div id="event_reg_theme" class="wrap">
			...
			<?php
			if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'before_survey') {
				require_once("before_survey.php");
				before_survey($_REQUEST['event_id']);
			}
			
			if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'after_survey') {
				require_once("after_survey.php");
				after_survey($_REQUEST['event_id']);
			}
