...
function espresso_event_templates($event_id=0) {
    global $wpdb, $org_options, $espresso_premium;
    ?>
		<p><strong>
        <a href="admin.php?page=templates&amp;action=edit_before_survay&amp;event_id=<?php echo $event_id ;  ?>" title="edit" target="_blank">Before surveys</a>
        
        <br />
        <a href="admin.php?page=templates&amp;action=edit_after_survay&amp;event_id=<?php echo $event_id ; ?>" title="edit" target="_blank">After surveys</a>
