...
//			$this->timer->start();
			...
			if ( $show_tooltips ) {
				...
				if (! $expired && $not_open){
					...
					//print_r($event);
					$events[ $cntr ]['tooltip'] .= '<div class="sold-out-dv"><a href="http://localhost/livingsmart/whats-happening/courses-events?page=after_survay_template&event_id='.$this_event_id.'">' . __('Registration Closed', 'event_espresso') . '</a></div>';
