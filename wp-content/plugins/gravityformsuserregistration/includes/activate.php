    ...
    <?php } else {
        ...
        if ( is_wp_error($result) ) {
            ...
            <?php if ( $url != network_home_url('', 'http') ) : ?>
                ...
                <p class="view"><?php printf( __('Your account is now activated. <a href="%1$s">View your site</a> or '), $url); ?>
               </p>

            <?php else: ?>

                <p class="view"><?php printf( __('Your account is now activated. for Login go back to the <a href="%2$s">homepage</a>.' ), network_site_url('wp-login.php', 'login'), network_home_url() ); ?></p>
