...

{
	...
	<p><label for="' . $label . '">' . __("Administrator Password:") . ' <input name="post_password" id="' . $label . '" type="password" size="20" /></label> <input class="button" type="submit" name="Submit" value="' . esc_attr__("Submit") . '" /></p>
