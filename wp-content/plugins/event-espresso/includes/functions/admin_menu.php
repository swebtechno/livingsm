...
if (!function_exists('add_event_espresso_menus')) {
    function add_event_espresso_menus() {
		...
		//Templates
        add_submenu_page('event_espresso', __('Event Espresso - Templates', 'event_espresso'), __('Templates', 'event_espresso'), apply_filters('espresso_management_capability', $default_role, isset($espresso_manager['espresso_manager_templates']) && !empty($espresso_manager['espresso_manager_templates']) ? $espresso_manager['espresso_manager_templates'] : $default_role), 'templates', 'event_espresso_templates_config_mnu');
